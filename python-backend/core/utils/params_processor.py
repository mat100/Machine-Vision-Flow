...
class ParamsProcessor:
    """
    Utility class for processing and preparing detection parameters.

    Provides standardized methods for parameter initialization, validation,
    and extraction to reduce duplication across detection services.
    """
