...
class TestVisionService:
    ...
    def test_template_match_success(self, mock_image_manager, mock_template_manager, mock_history_buffer):
    ...
    def test_template_match_image_not_found(self, mock_image_manager, mock_template_manager, mock_history_buffer):
    ...
    def test_template_match_template_not_found(self, mock_image_manager, mock_template_manager, mock_history_buffer):
    ...
    def test_template_match_with_roi(self, mock_image_manager, mock_template_manager, mock_history_buffer):
    ...
    def test_template_match_no_history(self, mock_image_manager, mock_template_manager, mock_history_buffer):
    ...
    def test_learn_template_from_roi(self, mock_image_manager, mock_template_manager, mock_history_buffer):
    ...
    def test_learn_template_image_not_found(self, mock_image_manager, mock_template_manager, mock_history_buffer):
        ...
        with pytest.raises(ImageNotFoundException):
            service.learn_template_from_roi(
                image_id='non-existent',
                roi=roi,
                name='Test'
            )

    def test_edge_detect_success(self, mock_image_manager, mock_template_manager, mock_history_buffer):
    ...
    def test_edge_detect_image_not_found(self, mock_image_manager, mock_template_manager, mock_history_buffer):
    ...
    def test_edge_detect_with_params(self, mock_image_manager, mock_template_manager, mock_history_buffer):
    ...
    def test_edge_detect_invalid_method(self, mock_image_manager, mock_template_manager, mock_history_buffer):
    ...
    def test_edge_detect_no_history(self, mock_image_manager, mock_template_manager, mock_history_buffer):
...
class TestVisionServiceIntegration:
    ...
    def test_template_match_integration(self, vision_service, test_image, test_template, image_manager, template_manager):
